...
from sim_consistency.data.constants import dataset_collection
from sim_consistency.data.datasets import breeds, cifar_coarse, imagenet_variants
...
def build_wds_dataset(transform, split="test", data_dir="root", cache_dir=None, selector_fn=None,
    ...
    (`sim_consistency.webdataset_builder.convert_dataset`) to convert data to this format.
